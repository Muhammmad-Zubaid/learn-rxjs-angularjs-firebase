;(function() {
  angular.module('example', ['rx']) .controller('AppCtrl', function($scope, firebaseRef) {
    ...
    var source2 = usersRef.observe("child_removed");//it will be called when u delete a user from the firebase directly
    source2.subscribe(function(changeData){
        console.log("child removed called");
        var id = changeData.snapshot.key();
